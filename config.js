...
class EnterpriseConfigurationManager {
    ...
    constructPrimaryConfigurationSchema() {
        return {
             ...
             */
            lavalink: {
                host: EnvironmentVariableProcessor.LAVALINK_HOST || "panel.visionhost.cloud", 
                port: EnvironmentVariableProcessor.LAVALINK_PORT || 2030,       
                password: EnvironmentVariableProcessor.LAVALINK_PASSWORD || "krypton", 
